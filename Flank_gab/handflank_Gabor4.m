...
if or(expType == 'e',expType == 'd')
    ...
    FileName =  strcat(ID, '_HandFlank_gab.csv'); 
...
% Screen('PutImage', window, Neutral1, LeftLoc);
% Screen('PutImage', window, Resp1Tar2, CenterLoc);
% Screen('PutImage', window, Resp2Tar2, RightLoc);
% Screen('Flip', window);
% WaitSecs(1);
% KbWait(-1);
% 
...
if TrDisCong(Order(Trial)) == 1
   DistractorOrient =  OrientSet(TrTarType(Order(Trial)));
else 
